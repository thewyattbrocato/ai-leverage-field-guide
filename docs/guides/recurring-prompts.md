...
*Build a personal prompt library for the work you do every week. Leverage compounds.*
...
```
FILE: prompts/status-update.md
ROLE: I'm a [role] reporting to [manager/team] on [project].
INPUT: paste this week's messy notes below.
OUTPUT:
  - First 2 lines: the status in one breath + the decision/ask.
  - Then 3 bullets: what moved, what's blocked, what's next.
  - Plain language. No hedge words ("I think maybe"). Under 200 words.
STOP WHEN: the ask is explicit and I'd be fine with my manager forwarding it.
```

Save it. Next week, paste new notes. Same quality, a tenth of the effort, and it gets better
as you tune it.
